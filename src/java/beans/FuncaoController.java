...
public class FuncaoController implements Serializable {
    ...
    private FuncaoJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new FuncaoJpaController(Persistence.createEntityManagerFactory("sisplatPU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(pageSize) {
                ...
                public int getItemsCount() {
                    return getJpaController().getFuncaoCount(filtered);
                }
                ...
                public DataModel createPageDataModel() {
                    ...
                    return new ListDataModel(getJpaController().findFuncaoFilter(filtered, getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    public void create() {
        try {
            ...
            JsfUtil.addSuccessMessage(FacesContext.getCurrentInstance().getApplication().getResourceBundle(context, "bundle").getString("FuncaoCreated"));
            clearFilter();
            recreateModel();
        } catch (Exception e) {
            FacesContext context = FacesContext.getCurrentInstance();
    ...
    public void update() {
        try {
            ...
            FacesContext context = FacesContext.getCurrentInstance();
            JsfUtil.addSuccessMessage(FacesContext.getCurrentInstance().getApplication().getResourceBundle(context, "bundle").getString("FuncaoUpdated"));
        } catch (Exception e) {
            FacesContext context = FacesContext.getCurrentInstance();
            JsfUtil.addErrorMessage(e, FacesContext.getCurrentInstance().getApplication().getResourceBundle(context, "bundle").getString("PersistenceErrorOccured"));
        }
    ...
    private void performDestroy() {
        try {
            ...
            FacesContext context = FacesContext.getCurrentInstance();
            JsfUtil.addSuccessMessage(FacesContext.getCurrentInstance().getApplication().getResourceBundle(context, "bundle").getString("FuncaoDeleted"));
        } catch (Exception e) {
            FacesContext context = FacesContext.getCurrentInstance();
            JsfUtil.addErrorMessage(e, FacesContext.getCurrentInstance().getApplication().getResourceBundle(context, "bundle").getString("PersistenceErrorOccured"));
        }
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getFuncaoCount(filtered);
